...
const LESSONS:Record<number,{eyebrow:string;heading:string;intro:string;items:Lesson[]}>= {
  1:{
    ...
    items:[
      {title:'Organisational knowledge',icon:BookOpen,p1:'Teams carry practical know-how, local documentation preserves context, and corporate knowledge can make useful material available across the organisation. In real work these forms complement each other: publishing more content is not enough if people at the point of work lack the capability to understand and apply it.',p2:'In the game, the strongest usable source at the relevant site helps you meet a Challenge. You can deliberately strengthen that base through Knowledge Transfer, Corporate Training, Codify Site Knowledge, Update Corporate Intranet and Lessons Learned / AAR.',interventions:'Knowledge Transfer · Corporate Training · Codify Site Knowledge · Update Intranet · Lessons Learned / AAR'},
      {title:'Deep Experts',icon:Users,p1:'Experts provide judgement, pattern recognition and depth that is hard to capture completely. They are powerful precisely because they know more than the surrounding organisation, but relying on one person for critical capability can create a Single Point of Failure.',p2:'In the game, Experts can support difficult Challenges and can transfer or deepen expertise during Invest. Build capability around them rather than treating the Expert as the problem.',interventions:'Train Expert · Knowledge Transfer'}
    ]
  },
  2:{
