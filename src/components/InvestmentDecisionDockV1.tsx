...
export const InvestmentDecisionDockV1:React.FC<Props>=({session,company,selectedSiteId,tool,onTool,onSelectSite,onSelectHQ,onSelectExpert})=>{
  ...
  return <div className="fixed right-3 top-[104px] z-[145] hidden min-[1100px]:flex items-start gap-2" aria-label="Investment decision support">
    {tool&&<aside className="max-h-[calc(100vh-122px)] w-[260px] overflow-y-auto rounded-2xl border-2 border-violet-500 bg-[#0b0f18]/[0.99] p-4 shadow-2xl backdrop-blur-lg">
