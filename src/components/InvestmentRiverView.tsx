...
export const InvestmentRiverView:React.FC<Props>=({company,mode,selectedDomain,selectedSiteId,sourceSiteId,selectedExpertId,highlightHQ=false,highlightAllSites=false,highlightDomain=false})=>{
 ...
 return <div className="h-full min-h-0 rounded-2xl border border-slate-700 bg-slate-950/95 p-3 shadow-inner">
  ...
  <svg viewBox={`0 0 ${W} ${H}`} className="mt-1 h-[calc(100%-42px)] min-h-[260px] w-full" role="img" aria-label="Knowledge River showing sites, corporate knowledge and experts">
