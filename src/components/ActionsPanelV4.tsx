...
export const ActionsPanelV4:React.FC<Props>=({session,company,onPerformAction,onNextPhase})=>{
 ...
 // Investment interventions consume Actions and money; they do not reserve an Expert for the round.
 ...
 const commit=()=>{
   const map:Record<InterventionId,[string,any]>={
    ...
    'aar':['LESSONS_LEARNED',{siteId,domain,learningTarget,eventInstanceId:selectedAarEvent?.instanceId}],
