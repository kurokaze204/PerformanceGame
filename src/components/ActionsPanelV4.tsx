...
export const ActionsPanelV4:React.FC<Props>=({session,company,onPerformAction,onNextPhase})=>{
 ...
 const relevantDomains=useMemo(()=>{
   ...
   return DOMAINS;
 },[selectedId,selectedSite,selectedExpert,session.activeEvents,company.id,needsExpert]);
