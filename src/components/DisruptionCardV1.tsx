...
export const DisruptionMiniCard:React.FC<{company:CompanyV2;aboveOverlay?:boolean;embedded?:boolean;wide?:boolean}>=({company,aboveOverlay=false,embedded=false,wide=false})=>{
 ...
 if(!card)return null;
 const shell=wide
  ?'relative w-[218px] min-h-[116px] rounded-[14px] border-[3px] border-amber-300 bg-[#171109] p-2.5 shadow-[0_8px_18px_rgba(0,0,0,.45)] pointer-events-auto'
  :embedded
