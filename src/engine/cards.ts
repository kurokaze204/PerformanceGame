import { EventCard, KnowledgeDomain, EventScope, EventType } from '../types/game.ts';
...
export const EVENT_CARDS_DECK: EventCard[] = [
  ...
  // 1-Domain (10 cards)
  {
    ...
    domains: [
      { domain: 'engineering', difficulty: 5 }
    ],
    impact: 130,
  ...
  },
  {
    ...
    domains: [
      { domain: 'operations', difficulty: 4 }
    ],
    impact: 110,
  ...
  },
  {
    ...
    domains: [
      { domain: 'engineering', difficulty: 6 }
    ],
    impact: 160,
    rdSiteOnly: true,
  ...
  },
  {
    ...
    domains: [
      { domain: 'operations', difficulty: 5 }
    ],
    impact: 140,
  ...
  // 2-Domains (7 cards)
  {
    ...
    domains: [
      { domain: 'engineering', difficulty: 5 },
      { domain: 'operations', difficulty: 3 }
    ],
    impact: 150,
  ...
  },
  {
    ...
    domains: [
      { domain: 'operations', difficulty: 4 },
      { domain: 'engineering', difficulty: 4 }
    ],
    impact: 150,
  ...
  },
  {
    ...
    domains: [
      { domain: 'finance', difficulty: 5 },
      { domain: 'engineering', difficulty: 3 }
    ],
    impact: 140,
  ...
  // 1-Domain (3 cards)
  {
    ...
    domains: [
      { domain: 'engineering', difficulty: 7 }
    ],
    impact: 260,
  ...
  // 2-Domains (2 cards)
  {
    ...
    domains: [
      { domain: 'operations', difficulty: 7 },
      { domain: 'finance', difficulty: 5 }
    ],
    impact: 300,
  ...
  },
  {
    ...
    domains: [
      { domain: 'marketing', difficulty: 7 },
      { domain: 'finance', difficulty: 6 }
    ],
    impact: 280,
  ...
  // 3-Domains (1 card)
  {
    ...
    domains: [
      { domain: 'engineering', difficulty: 8 },
      { domain: 'operations', difficulty: 6 },
      { domain: 'finance', difficulty: 5 }
    ],
    impact: 380,
...
export const FINAL_DISRUPTION_CARDS: EventCard[] = [
  {
    id: 'FINAL-DISRUPT-001',
    type: 'problem',
    scope: 'enterprise',
  ...
  },
  {
    ...
    domains: [
      { domain: 'operations', difficulty: 8 },
      { domain: 'engineering', difficulty: 8 },
      { domain: 'hr', difficulty: 6 }
    ],
    impact: 550,
...
export function getRandomEventCard(scope?: EventScope, type?: EventType): EventCard {
  ...
  if (scope) {
    deck = deck.filter((c) => c.scope === scope);
  }
  if (type) {
    deck = deck.filter((c) => c.type === type);
  }
